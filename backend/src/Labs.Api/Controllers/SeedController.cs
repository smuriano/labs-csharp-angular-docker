  ...
  public class SeedController : ControllerBase
  {
    ...
    public async Task<ActionResult<string>> GetAll()
    {
      try
      {
        ...
        //   exames.Add(new Exame("Hemograma", 12.34));
        //   exames.Add(new Exame("Hemograma", 12.34));
        //   exames.Add(new Exame("Glicose", 12.34));
        //   exames.Add(new Exame("GPP", 12.34));
        //   exames.Add(new Exame("Glicemia", 12.34));
        //   exames.Add(new Exame("Colesterol e triglicerídeos", 12.34));
        //   exames.Add(new Exame("TGO", 12.34));
        //   exames.Add(new Exame("TGP", 12.34));
        //   exames.Add(new Exame("TSH", 12.34));
        //   exames.Add(new Exame("T4L", 12.34));
        //   exames.Add(new Exame("Ácido úrico", 12.34));
        //   exames.Add(new Exame("Eletrocardiograma", 12.34));
        //   exames.Add(new Exame("Ecocardiograma", 12.34));
        //   exames.Add(new Exame("PSA", 12.34));
        //   exames.Add(new Exame("GPP", 12.34));
        //   exames.Add(new Exame("HbA1C", 12.34));
        //   exames.Add(new Exame("HDL", 12.34));

        //   exames.ForEach(x => _exameRepository.AddAsync(x));
        //   await _exameRepository.SaveAsync();
        ...
        //   await _medicoRepository.SaveAsync();
        ...
        //   await _pacienteRepository.SaveAsync();
        ...
        //   await _postoColetaRepository.SaveAsync();
